...
static translation_string all_strings[] = {
    ...
    {TR_HOTKEY_RESIZE_TO_720, "Изменить размер на 1280x720"},
    {TR_HOTKEY_RESIZE_TO_1080, "Изменить размер на 1920x1080"},
    {TR_HOTKEY_RESIZE_TO_1440, "Изменить размер на 2560x1440"},
