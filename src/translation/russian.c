...
static translation_string all_strings[] = {
    ...
    {TR_HOTKEY_RESIZE_TO_720, "Изменить размер на 640x480"},
    {TR_HOTKEY_RESIZE_TO_1080, "Изменить размер на 800x600"},
    {TR_HOTKEY_RESIZE_TO_1440, "Изменить размер на 1024x768"},
