...
static translation_string all_strings[] = {
   {TR_NO_PATCH_TITLE, "Atualização 1.0.1.0 não instalada"},
    ...
    {TR_CONFIG_TITLE, "Opções de Configurações do Octavius"},
    ...
    {TR_HOTKEY_TITLE, "Configurações de teclas de atalho do Octavius"},
    ...
    {TR_HOTKEY_RESIZE_TO_720, "Redimensionar para 1280x720"},
    {TR_HOTKEY_RESIZE_TO_1080, "Redimensionar para 1920x1080"},
    {TR_HOTKEY_RESIZE_TO_1440, "Redimensionar para 2560x1440"},
