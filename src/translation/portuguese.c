...
static translation_string all_strings[] = {
   {TR_NO_PATCH_TITLE, "Atualização 1.0.1.0 não instalada"},
    ...
    {TR_HOTKEY_HEADER_BUILD, "TRANSLATEME: Build hotkeys"},
    ...
    {TR_HOTKEY_BUILD_CLEAR, "TRANSLATEME: Clear tool"},
    {TR_HOTKEY_BUILD_VACANT_HOUSE, "TRANSLATEME: Build house"},
    {TR_HOTKEY_BUILD_ROAD, "TRANSLATEME: Build road"},
