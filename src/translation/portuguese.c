...
static translation_string all_strings[] = {
   {TR_NO_PATCH_TITLE, "Atualização 1.0.1.0 não instalada"},
    ...
    {TR_HOTKEY_RESIZE_TO_720, "Redimensionar para 640x480"},
    {TR_HOTKEY_RESIZE_TO_1080, "Redimensionar para 800x600"},
    {TR_HOTKEY_RESIZE_TO_1440, "Redimensionar para 1024x768"},
