...
static translation_string all_strings[] = {
    ...
    {TR_HOTKEY_RESIZE_TO_720, "重置分辨率至1280x720"},
    {TR_HOTKEY_RESIZE_TO_1080, "重置分辨率至1920x1080"},
    {TR_HOTKEY_RESIZE_TO_1440, "重置分辨率至2560x1440"},
