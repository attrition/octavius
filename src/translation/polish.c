...
static translation_string all_strings[] = {
    ...
    {TR_HOTKEY_RESIZE_TO_720, "Zmień rozmiar okna do 640x480"},
    {TR_HOTKEY_RESIZE_TO_1080, "Zmień rozmiar okna do 800x600"},
    {TR_HOTKEY_RESIZE_TO_1440, "Zmień rozmiar okna do 1024x768"},
