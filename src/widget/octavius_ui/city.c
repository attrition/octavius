...
void draw_button_bar(void)
{
    ...
    build_buttons_draw(buttons_offset_x + 7, buttons_offset_y + 7, buttons_build, 12);
}
...
void draw_minimap(void)
{
    ...
    widget_minimap_draw(map_offset_x, map_offset_y, map_grid_width() * 2, map_grid_height() * 2, 0);
}
...
int widget_octavius_ui_city_handle_mouse(const mouse *m)
{
    ...
    handled = build_buttons_handle_mouse(m, buttons_offset_x, buttons_offset_y, buttons_build, 12, &button_id);
    if (button_id) {
