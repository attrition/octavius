...
static void draw_foreground(void)
{
    ...
    text_draw_centered(translation_for(TR_HOTKEY_RESIZE_TO_720),  128, 164, 224, FONT_NORMAL_GREEN, 0); // 720p
    text_draw_centered(translation_for(TR_HOTKEY_RESIZE_TO_1080), 128, 188, 224, FONT_NORMAL_GREEN, 0); // 1080p
    text_draw_centered(translation_for(TR_HOTKEY_RESIZE_TO_1440), 128, 212, 224, FONT_NORMAL_GREEN, 0); // 1440p
